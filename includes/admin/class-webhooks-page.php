...
class Webhooks_Page {
    ...
    public function init(): void {
        add_action( 'wp_ajax_postkind_indieweb_regenerate_webhook_secret', array( $this, 'ajax_regenerate_secret' ) );
        add_action( 'wp_ajax_postkind_indieweb_clear_pending_scrobbles', array( $this, 'ajax_clear_pending' ) );
        add_action( 'wp_ajax_postkind_indieweb_approve_scrobble', array( $this, 'ajax_approve_scrobble' ) );
        add_action( 'wp_ajax_postkind_indieweb_reject_scrobble', array( $this, 'ajax_reject_scrobble' ) );
    }
    ...
    public function render(): void {
        ...
        $settings = get_option( 'post_kinds_indieweb_webhook_settings', array() );
        $pending = get_option( 'post_kinds_indieweb_pending_scrobbles', array() );
    ...
    private function render_webhook_log(): void {
        $log = get_option( 'post_kinds_indieweb_webhook_log', array() );
    ...
    public function ajax_regenerate_secret(): void {
        ...
        if ( empty( $webhook ) || ! isset( $this->webhook_configs[ $webhook ] ) ) {
            wp_send_json_error( array( 'message' => __( 'Invalid webhook.', 'post-kinds-for-indieweb' ) ) );
        }
    ...
    public function ajax_clear_pending(): void {
        ...
        wp_send_json_success( array( 'message' => __( 'Pending scrobbles cleared.', 'post-kinds-for-indieweb' ) ) );
    }
    ...
    public function ajax_approve_scrobble(): void {
        ...
        if ( ! isset( $pending[ $index ] ) ) {
            wp_send_json_error( array( 'message' => __( 'Scrobble not found.', 'post-kinds-for-indieweb' ) ) );
        }
    ...
    public function ajax_reject_scrobble(): void {
        ...
        wp_send_json_success( array( 'message' => __( 'Scrobble rejected.', 'post-kinds-for-indieweb' ) ) );
    }
